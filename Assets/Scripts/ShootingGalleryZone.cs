...
public class ShootingGalleryZone : MonoBehaviour
{
    ...
    private void Update()
    {
        if (m_IsPlayerInside)
        {
            ...
            m_TimerText.text = "Time: " + Mathf.RoundToInt(m_Timer); //Pregunta a IA. Pregunta "En Visual Studio para Unity3D como hago para que los segundos no salgan decimales?"
